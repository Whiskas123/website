...
export default function Home() {
  ...
  const slides = [
    ...
    {
      title:
        "Trabalho XXI: A agenda anti laboral e antissindical que é imperioso travar",
      subtitle: "",
...

    {
      ...
      section: "Contra-reforma laboral",
      id: "210",
      imageUrl: "/images/210.jpg",
    },
    {
      title:
        "Trabalhadores da Lusa em greve contra a instrumentalização da agência pelo Governo",
      subtitle: "",
      author: "",
      section: "",
      id: "222",
  ...
  const slidesMediumContraReforma = [
    ...
    },
    {
      ...
      subtitle: "",
      author:
        "Joana Guimarães, Joana S. Marques, Ana Luísa Martinho, Joana Topa",
      section: "Trabalho e Imigração",
      id: "205",
      imageUrl: "/images/205.jpg",
    },
    {
      title:
        "Trabalho em plataformas digitais na atualidade e a Associação de Imigrantes e Trabalhadores por Aplicação",
      subtitle: "",
      author: "Marcel Borges, Hans Donner",
      section: "Trabalho e Imigração",
      id: "206",
      imageUrl: "/images/206.jpg",
    },
    {
      title:
        "Capitalismo (Racial) de Plataformas e a realidade dos estafetas em Portugal",
      subtitle: "",
    ...
    },
    {
      ...
      subtitle:
        "Entre envelhecimento, escassez de trabalhadores e constrangimentos à entrada e permanência de mão-de-obra estrangeira",
    ...
    {
      title:
        "Condições de trabalho e controle público: imigrantes e trabalho informal",
      subtitle: "",
      author: "João Fraga de Oliveira",
      section: "Trabalho e Imigração",
      id: "204",
      imageUrl: "/images/204.jpg",
    },

    {
      title:
        "Trabalho e Imigração: algumas notas para interpretar e transformar o presente",
      subtitle: "",
      author: "José Soeiro",
      section: "Trabalho e Imigração",
      id: "201",
      imageUrl: "/images/201.jpg",
    },
    {
    ...
    {
      title:
        "Algumas propostas de alteração do regime jurídico dos despedimentos por motivos económicos",
      subtitle: "",
      author: "Catarina Gomes Santos",
      section: "Contra-reforma laboral",
      id: "214",
      imageUrl: "/images/214.jpg",
    },
    {
      ...
      section: "Contra-reforma laboral",
      id: "215",
      imageUrl: "/images/215.jpg",
    },
    {
      title: "A democracia não pode ficar à porta das empresas",
      subtitle:
        "A propósito de uma conferência internacional sobre democracia económica",
    ...
    },
    {
      ...
      subtitle:
        "A iniciativa Legislativa Cidadã com vista ao encerramento do comércio ao domingo",
      author: "Joana Neto",
      section: "Consultório Jurídico",
      id: "217",
      imageUrl: "/images/217.jpg",
    },
    {
      title:
        "Artigo 498.º-A 'Terceirização de serviços' -- breves considerações",
      subtitle: "",
      author: "Ana Teresa Ribeiro",
      section: "Consultório Jurídico",
      id: "218",
      imageUrl: "/images/218.jpg",
    },
    {
      title: "Sindicatos",
      subtitle: "",
      ...
      id: "219",
      imageUrl: "/images/219.jpg",
    },
    {
      title: "Cromos da Caderneta de Trabalho",
      subtitle: "",
      author: "Jorge Louraço Figueira",
      section: "Abecedário Crítico",
      id: "220",
      imageUrl: "/images/220-0.jpg",
    },
    {
